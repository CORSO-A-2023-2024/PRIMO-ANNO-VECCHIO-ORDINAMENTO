...
public class AppelloDiFebbraio00 {
	 ...
	 */
	 ...
	 public class boolean exUno(int[] a, int[] b){
	 ...
	 */
     ...
     static int exDue(int [] a){
		 if(a == null || a.length == 0)
			 return -1;
		 else return exDueRic(a, 0, a.length-1);
	 }
	 static int exDueRic(int [] a, int l, int r){
		 if(l == r)
			 if(l % 2 != 0) return test(a[l]);
		 else{
			int m = (l + r) / 2;
